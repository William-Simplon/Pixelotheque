...
require "../ressources/template/_header-create.php";
$title = "inscription";
...
<body>
    <div class="big-contain">
        ...
        <div class="right-contain" id="right-contain">
            <form action="" method="POST">
                <p class="seCoo">S'INSCRIRE :</p>
                ...
                <!-- email -->
                <label for="email" class="nomD">Email :</label>
                <input type="email" id="email" name="email" class="email" required></input>
                ...
                <!-- CONFIRMATION MDP-->
                <label for="passwordBis" class="nomD">Confirmer Mot de passe :</label>
                <input type="passwordBis" id="passwordBis" name="passwordBis" id="passwordBis" required></input>
